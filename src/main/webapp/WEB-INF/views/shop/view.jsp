...
<head>
	...
	<style>
	 ...
	 div.modalContent { position:fixed; top:20%; left:calc(50% - 250px); width:525px; height:250px; padding:20px 10px; background:#fff; border:2px solid #666; }
			...
			<section id = "content">
				...
				<div class="goods">
				 ...
				 <div class="goodsInfo">
				  ...
				  <p class="cartStock">
					 <span>구입 수량</span>
					  <input type="number" class="numBox" min="1" max="${view.gdsStock}" style='text-align:center' value="1" readonly="readonly"/>
					 
					<ul class="actions">
						<li><button type="button" class="plus" style ='align:center'>+</button></li>
						<li><button type="button" class="minus"style ='align:center'>-</button></li>
					</ul>
